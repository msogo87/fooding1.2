...
public class CityGuideConfig
{
	...
	public static final String ADMOB_UNIT_ID_POI_LIST = null; // "ca-app-pub-XXXXXXXXXXXXXXXXXXXXXXXXXXX";
	public static final String ADMOB_UNIT_ID_POI_DETAIL = null; // "ca-app-pub-XXXXXXXXXXXXXXXXXXXXXXXXXXX";
	public static final String ADMOB_UNIT_ID_MAP = null; //"ca-app-pub-XXXXXXXXXXXXXXXXXXXXXXXXXXX";
	...
	public static final String ADMOB_TEST_DEVICE_ID = null; //"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
